...
import { getEntitlements, hasDailyReminders } from "@/lib/entitlements";
...
export default function Home() {
  ...
  const dailyRemindersUnlocked = hasDailyReminders(entitlements);
      ...
      <main className="relative z-10 container max-w-md mx-auto px-4 py-6 min-h-screen flex flex-col">
        ...
        <header className="flex items-center justify-between mb-8 pt-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Preferences */}
            <PreferencesDrawer
              hasDailyReminders={dailyRemindersUnlocked}
